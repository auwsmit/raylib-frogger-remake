...
#ifndef FROGGER_LOGO_HEADER_GUARD
#define FROGGER_LOGO_HEADER_GUARD

// Macros
// ----------------------------------------------------------------------------
#define RAYLIB_LOGO_WIDTH 256 // takes multiples of 64
...
#define RAYLIB_LOGO_BACKGROUND DARKGREEN
#define RAYLIB_LOGO_COLOR GREEN
...
#endif // FROGGER_LOGO_HEADER_GUARD
